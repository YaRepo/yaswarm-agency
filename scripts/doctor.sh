...
check_dir "$AGENCY_ROOT/desk/inbox"
check_dir "$AGENCY_ROOT/desk/wip"
check_dir "$AGENCY_ROOT/desk/review"
check_dir "$AGENCY_ROOT/desk/done"
check_dir "$AGENCY_ROOT/desk/rejected"
...
check_file "$CONFIG_ROOT/mcp-config.json"
check_file "$CONFIG_ROOT/project-repo-defaults.json"
check_file "$CONFIG_ROOT/data-services.json"
