...
echo "Next steps:"
echo "  1) Run setup: yaswarm setup --workspace $WORKSPACE --owner <github_owner>"
echo "  2) Start stack: yaswarm up"
echo "  3) Verify: yaswarm doctor"
echo "  4) Create project repo: yaswarm init-project <project_name>"
